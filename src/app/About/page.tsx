...
const SkillRadar = () => (
  <div className="flex flex-col items-center gap-6">
    <div className="text-center text-lg font-semibold text-blue-700 dark:text-[#98BAD2]">
      技能分佈
    </div>
...
const achievements = {
  "2023": ["市立木柵高工畢業 (電機科)", "全國技藝競賽 工業配線 金手獎第七名"],
  "2024": ["雲林科技大學 資管系AI專班 就讀中", "校內團體程式競賽佳作"],
};
...
const Timeline = ({
  ...
  >
    ...
    <h3 className="text-2xl font-bold mb-4 text-blue-700 dark:text-[#98BAD2] pl-4">
      {title}
    </h3>
    ...
    <div className="w-full flex flex-col items-center text-white">
      ...
      <div className="w-full max-w-6xl px-4 -mt-30 flex flex-col items-center justify-start gap-8">
        ...
        <div className="flex flex-col items-center justify-start gap-4 text-center">
          ...
          >
            I enjoy working with modern technologies and continuously learning
      ...
      <div className="w-full max-w-6xl px-4 mt-12 flex flex-col gap-8">
        <Card title="關於我">
          嗨嗨～我是林奕安，一名來自雲林科技大學資訊管理系 AI
          專班的學生，熱愛結合軟硬體技術打造創新專案。我擁有程式設計、機器學習與硬體控制經驗，持續精進中！
        </Card>
